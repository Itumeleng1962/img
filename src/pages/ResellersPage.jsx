...
import { Users, Layers, Zap, Server, Check, ArrowRight, Sparkles } from 'lucide-react';
import { contactDetails } from '../mock';

const RESELLER_PLANS = [
  { name: 'Reseller Mini', price: 'R299', disk: '20GB SSD', domains: 'Up to 10 domains', orderUrl: 'https://ataglance.imagine.co.za/cart.php' },
  { name: 'Reseller Medium', price: 'R599', disk: '50GB SSD', domains: 'Up to 25 domains', orderUrl: 'https://ataglance.imagine.co.za/cart.php' },
  { name: 'Reseller Executive', price: 'R999', disk: '100GB SSD', domains: 'Up to 50 domains', comingSoon: true, orderUrl: 'https://ataglance.imagine.co.za/cart.php' }
];
    ...
    <Layout>
      ...
      <section className="relative overflow-hidden pt-28 pb-20 px-6 lg:px-10 text-white"
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <a href="https://ataglance.imagine.co.za/cart.php" target="_blank" rel="noopener noreferrer" className="bg-[#E4002B] hover:bg-[#c40025] px-6 py-3.5 rounded-xl font-bold text-sm inline-flex items-center gap-1.5 transition-colors text-white shadow-md">
            Order Reseller Plan on Client Portal <ArrowRight size={15} />
          </a>
        </div>
      </section>
      ...
      <section className="py-16 px-6 lg:px-10 bg-gray-50">
        <div className="max-w-5xl mx-auto space-y-10">
          <div className="text-center">
            <h2 className="text-2xl font-black text-[#0f1720]">Plesk Reseller Hosting Packages</h2>
              ...
              <div key={plan.name} className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm flex flex-col justify-between hover:shadow-md hover:border-[#E4002B]/40 transition-all relative overflow-hidden">
                ...
                <div>
                  ...
                  <div className="mt-3 flex items-baseline">
                    <span className="text-3xl font-black text-[#0f1720]">{plan.price}</span>
      ...
      <section className="py-16 px-6 lg:px-10 bg-white">
        <div className="max-w-5xl mx-auto space-y-12">
          <div className="text-center">
            <h2 className="text-2xl font-black text-[#0f1720]">Enterprise Technical Performance</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { icon: Layers, title: 'Reseller API & WHMCS Module', desc: 'Self-service API endpoint hooks for automated provisioning of client accounts.', comingSoon: true }
            ].map((feat) => {
              const Icon = feat.icon;
              return (
                <div key={feat.title} className="text-center space-y-3 relative p-2 rounded-xl">
                  ...
                  <div className="flex items-center justify-center gap-2">
                    ...
                    {feat.comingSoon && <span className="bg-[#E4002B] text-white text-[8px] font-black px-1.5 py-0.5 rounded uppercase">Coming Soon</span>}
                  </div>
