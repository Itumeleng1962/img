...
export const navLinks = [
  ...
  },
  {
    ...
    to: '/services/hosting',
    submenu: [
      { label: 'Shared Hosting', to: '/services/hosting?tab=shared' },
      { label: 'Hosting for WordPress', to: '/services/wordpress' },
      { label: 'VPS Hosting', to: '/services/hosting?tab=vps' },
      { label: 'Enterprise Hosting', to: '/services/hosting?tab=vps' },
      { label: 'LiteSpeed Hosting', to: '/services/hosting?tab=shared' },
      { label: 'Dedicated Servers', to: '/services/hosting?tab=vps' },
      { label: 'Virtual Machines', to: '/services/hosting?tab=vps' },
  ...
  },
  {
    ...
    submenu: [
      ...
      { label: 'Managed Email Hosting', to: '/services/email#reseller' },
      { label: 'Personal Email Hosting', to: '/services/email' },
      { label: 'Bulk SMTP Services', to: '/services/email' },
      { label: 'Anti Spam Protection', to: '/services/email#security' },
